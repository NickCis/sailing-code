...
See [sphinxbase.spec example](/example/sphinxbase.spec)
...
Make sure that the "MerSDK" Virtual Box machine is running, since the cross compilation is done inside the Virtual Box. You can start it as explained in [Develop without qt-creator]({% post_url 2015-01-01-develop-without-qtcreator %})
